...
Source: **https://github.com/baditaflorin/mesh-chore-rotation**
...
git clone https://github.com/baditaflorin/mesh-chore-rotation
cd mesh-chore-rotation
npm install
npm run dev
```
...
- `mesh-chore-rotation:signalingUrl`
- `mesh-chore-rotation:turnTokenUrl`
- `mesh-chore-rotation:iceServers`
- `mesh-chore-rotation:room`
